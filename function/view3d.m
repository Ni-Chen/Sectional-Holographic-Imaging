function view3d(im,pos,tt,newfig)
...
text(-5,pos(1),['y=',num2str(pos(1))],'FontSize',14,'HorizontalAlignment','right')
text(pos(2),-7,['x=',num2str(pos(2))],'FontSize',14,'HorizontalAlignment','center')
