function [x, x_debias, objective, times, debias_start, mses]= GPSR_Basic(y, A, tau, varargin)
%{ 
This function solves the convex problem 
       arg min_x = 0.5*|| y - A x ||_2^2 + tau || x ||_1
using the algorithm GPSR-Basic, described in:
- M. A. T. Figueiredo, R. D. Nowak, S. J. Wright, "Gradient Projection for Sparse Reconstruction: 
Application to Compressed Sensing and Other Inverse Problems," IEEE Journal of selected topics in 
signal processing, 1(4), 586-597, 2007.
...
hereby granted,  provided that this entire notice is included in all copies of any software which is
or includes a copy or modification of this software and in all copies of the supporting documentation
for such software.
